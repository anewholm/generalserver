      ...
      <table id="main"><tr>
        <td>
          ...
          <table>
            ...
            <tr><td>system-transform  </td><td><select disabled="1" name="system-transform">
              <option value="">none</option>
              <!-- xsl:apply-templates select="/config/system_transforms/xsl:stylesheet/@name" mode="gs_options"/-->
            </select>
            </td><td class="help">name of xsl:stylesheet in system_transforms</td></tr>
