...
/* Annesley: debug funcs */
#undef  xmlGenericDebug
#undef  xmlGenericDebugContext
...
/**
 * xmlGenericDebug:
 * xmlGenericDebugContext:
 *
 * Global setting: function used for generic debug callbacks
 */
xmlGenericDebugFunc xmlGenericDebug = xmlGenericDebugDefaultFunc;
void *xmlGenericDebugContext = NULL;
...
xmlInitializeGlobalState(xmlGlobalStatePtr gs)
{
    ...
    /* Annesley: new XSLT style debugging setup */
    gs->xmlGenericDebug = xmlGenericDebugDefaultFunc;
    gs->xmlGenericDebugContext = NULL;
...
#undef  xmlGenericDebug
xmlGenericDebugFunc *
__xmlGenericDebug(void) {
    if (IS_MAIN_THREAD)
        return (&xmlGenericDebug);
    else
        return (&xmlGetGlobalState()->xmlGenericDebug);
}

#undef  xmlGenericDebugContext
void * *
__xmlGenericDebugContext(void) {
    if (IS_MAIN_THREAD)
        return (&xmlGenericDebugContext);
    else
        return (&xmlGetGlobalState()->xmlGenericDebugContext);
}
